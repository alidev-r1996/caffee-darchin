...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-2 md:flex-row bg-slate-50 max-h-screen md:h-[60vh] p-4">
      <div className="flex flex-col md:gap-12 gap-8 w-full md:w-2/4 justify-center items-center p-4 mb-8 md:mb-0">
        ...
        <p className="zinc-400 px-8 text-center text-sm md:text-base">فضایی مدرن، صمیمی و جذاب برای یک غذای فراموش نشدنی</p>
      </div>
