...
export const PrevButton = ({ onClick }: { onClick: () => void }) => (
    <button
      onClick={onClick}
      className="rounded-full bg-gray-100 cursor-pointer dark:bg-gray-700 p-2 hover:bg-gray-300 dark:hover:bg-gray-600 transition"
  ...
  export const NextButton = ({ onClick }: { onClick: () => void }) => (
    <button
      onClick={onClick}
      className="rounded-full bg-gray-200 cursor-pointer dark:bg-gray-700 p-2 hover:bg-gray-300 dark:hover:bg-gray-600 transition"
      aria-label="Next Slide"
    >
      <ChevronRight className="rotate-180 text-slate-500 size-5" />
    </button>
  );
